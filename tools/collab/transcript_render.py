...
Does not own: registry state, phase lifecycle decisions, participant roster
              ...
              This module is imported by tools.collab.registry only.
...
from tools.collab.errors import die  # noqa: E402
from tools.collab.handoff_shape import render_content_for_transcript, validate_handoff_state  # noqa: E402
from tools.collab.normalizers import format_banner_timestamp, phase_slug  # noqa: E402
from tools.collab.participants import (  # noqa: E402
...
from tools.collab.registry_constants import (  # noqa: E402
...
from tools.collab.transcript_readers import (  # noqa: E402
    DETAILS_CLOSE_RE,
    DETAILS_OPEN_RE,
    summary_role,
)

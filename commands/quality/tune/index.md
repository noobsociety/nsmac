...
10. For universal gaps, present proposed criteria and run [quality-learning](../../../platform/standards/quality-learning.md) **Protocol** steps 2–6. Do not edit any playbook until the gate completes and the user confirms.

...
- **Authored-state invariant:** Registry-owned defaults and state transitions are stamped on write and read back from stored fields. Computed read surfaces, such as status views and digests, are views over already-authored state; they never synthesize registry-owned defaults.

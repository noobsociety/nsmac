...
| Completion | `run-plan.md` step 7 (no `**mod:**` Action Plan items collected; nothing to implement — report and stop) | `run-plan.md` steps 5 (Completion-only guard), 6 (role resolution), 7 (unchecked item collection), 13 (scoped validation), 14 (checkbox update), 15 (execution recording); `participant-verify.md` steps 5–14 | `run-plan.md` steps 5 (Completion-only guard), 6 (role resolution), 7 (unchecked item collection), 13 (scoped validation), 14 (checkbox update), 15 (execution recording); `participant-verify.md` steps 5–14 | `seal-verification.md` steps 5–14 |

---

For effort levels per phase and role, see [`agent-effort.md`](agent-effort.md).

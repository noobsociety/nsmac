...
3. Stop. The route is read-only and must not mutate the registry or transcript.

## Notes

- **Parameters:** none.
- **Source of truth:** `platform/standards/flag-taxonomy.md` owns all flag rows and classifications. The route does not duplicate flag docs by hand.

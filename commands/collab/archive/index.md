...
- **Clear notice:** The helper emits `{"message": "Run /clear before starting another collab.", "notice": "clear", "status": "archived"}` after archiving. Display this to the caller. Route docs describe the output; they do not reimplement it. See [invariants.md](../../../core/collab/invariants.md).

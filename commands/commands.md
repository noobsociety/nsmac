...
`(test <target>)` may also require `~/nsmac/tests/specs/commands.md`, `~/nsmac/tests/specs/core.md`, `~/nsmac/tests/specs/roles.md`, and `REPOSITORY.md`.
...
- **`(test <commands | core | roles | repo | all>)`** — run one QA harness target or all in sequence.
...
| `(test <commands \| core \| roles \| repo \| all>)` | [test](test/index.md) | n/a |
...
| `(collab advance [<target>])` | [collab/advance/index.md](collab/advance/index.md) |
| `(collab archive [<target>])` | [collab/archive/index.md](collab/archive/index.md) |
| `(collab close [<target>])` | [collab/close/index.md](collab/close/index.md) |
...
| `(collab seal verification [--outcome <outcome>] [--restore-target <target>] [--restore-reason <reason>] [--evidence <json>] [--failure-category <category>] [--null-result])` | [collab/seal-verification/index.md](collab/seal-verification/index.md) |

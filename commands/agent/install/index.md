...
2. Verify `~/.cursor/platform/templates/CLAUDE.md`, `~/.cursor/platform/templates/AGENTS.md`, and `~/.cursor/platform/templates/REPOSITORY.md` all exist. If any is missing, **ABORT** naming the missing path.
...
8. Copy `~/.cursor/platform/templates/REPOSITORY.md` to `<repo-root>/REPOSITORY.md`. These copy steps apply `the candidate patch` without recomputation or re-read of source.

...
run_case() {
  ...
  completed_output="$("$ROOT/commands/collab/engine/registry.py" execution "$target" pe completed "2026-05-17T12:05:00+02:00" \
    --assigned-role tw \
    --assigned-role pe \
    --validation-result passed \
    --validation-scope scoped \
  ...
  output="$("$ROOT/commands/collab/engine/registry.py" execution "$target" tw in_progress "2026-05-17T12:10:00+02:00" \
    --assigned-role tw \
    --assigned-role pe \
    --caller-role tw 2>&1)"

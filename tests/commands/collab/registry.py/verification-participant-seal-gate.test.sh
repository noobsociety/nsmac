...
"$ROOT/commands/collab/engine/registry.py" init --agent-id codex --reviewer pa "Verification Participant Seal Gate" >/dev/null
...
participant_speak_state="$("$ROOT/commands/collab/engine/registry.py" speak-state "$TARGET" pe)"

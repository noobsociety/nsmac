...
"$ROOT/commands/collab/engine/registry.py" out-of-scope-patch "$TARGET" pe \
  --path tests/commands/collab/registry.py/seal-stale-out-of-scope-patch.test.sh \
  --caller-role pe >/dev/null

assert_seal_stale \
  "seal-stale-out-of-scope-patch" \
  "out-of-scope patch outside declared writeScope: tests/commands/collab/registry.py/seal-stale-out-of-scope-patch.test.sh"

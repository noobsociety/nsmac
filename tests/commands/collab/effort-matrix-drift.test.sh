...
"$ROOT/commands/collab/engine/registry.py" audit-effort-matrix >/dev/null

sed '/generated; do not edit/d' \
  "$ROOT/commands/collab/reference/agent-model.md" >"$TMPDIR/no-marker.md"

set +e
marker_output="$("$ROOT/commands/collab/engine/registry.py" audit-effort-matrix \
...
sed 's/| Conclusion | low | medium | medium | xhigh |/| Conclusion | low | medium | high | xhigh |/' \
  "$ROOT/commands/collab/reference/agent-model.md" >"$TMPDIR/drift.md"

set +e
drift_output="$("$ROOT/commands/collab/engine/registry.py" audit-effort-matrix \
...
grep -v '^| Completion\.verification |' \
  "$ROOT/commands/collab/reference/agent-model.md" >"$TMPDIR/missing-row.md"

set +e
row_output="$("$ROOT/commands/collab/engine/registry.py" audit-effort-matrix \

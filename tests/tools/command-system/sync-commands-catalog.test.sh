...
COMMAND_CONFIG_ROOT="$fixture" "$ROOT/tools/command-system/sync-commands-catalog.sh" >/dev/null
COMMAND_CONFIG_ROOT="$fixture" "$ROOT/tools/command-system/sync-commands-catalog.sh" --check >/dev/null
COMMAND_CONFIG_ROOT="$fixture" "$ROOT/tools/command-system/audit-flag-scope.sh" >/dev/null

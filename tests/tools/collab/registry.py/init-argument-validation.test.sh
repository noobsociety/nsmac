...
set +e
none_terminal_output="$("$ROOT/tools/collab/registry.py" init --agent-id codex --terminal none "None Terminal" 2>&1)"
...
set +e
issue_terminal_output="$("$ROOT/tools/collab/registry.py" init --agent-id codex --terminal issue "Issue Terminal" 2>&1)"
...
default_output="$("$ROOT/tools/collab/registry.py" init --agent-id codex "Default Seal" 2>&1)"

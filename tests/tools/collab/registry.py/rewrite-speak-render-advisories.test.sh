...
init_target() {
  local title="$1"
  "$ROOT/tools/collab/registry.py" init --agent-id codex "$title" >/dev/null
...
"$ROOT/tools/collab/registry.py" join-participants "$PLAIN_TARGET" pe --agent-id gpt >/dev/null
"$ROOT/tools/collab/registry.py" set "$PLAIN_TARGET" turn-order pe --caller-role mod >/dev/null
"$ROOT/tools/collab/registry.py" set "$PLAIN_TARGET" active-phase Discussion --force --caller-role mod >/dev/null
printf 'Initial pe contribution.\n' >plain-initial.md
"$ROOT/tools/collab/registry.py" speak-render "$PLAIN_TARGET" pe \
...
"$ROOT/tools/collab/registry.py" rewrite-speak-render "$PLAIN_TARGET" pe \
...
"$ROOT/tools/collab/registry.py" join-participants "$NOTICE_TARGET" pe --agent-id gpt >/dev/null
"$ROOT/tools/collab/registry.py" join-participants "$NOTICE_TARGET" pa --agent-id claude >/dev/null
"$ROOT/tools/collab/registry.py" set "$NOTICE_TARGET" turn-order pe --caller-role mod >/dev/null
"$ROOT/tools/collab/registry.py" set "$NOTICE_TARGET" reviewer pa --caller-role mod >/dev/null
"$ROOT/tools/collab/registry.py" set "$NOTICE_TARGET" active-phase Discussion --force --caller-role mod >/dev/null
printf 'Initial pe contribution before reviewer.\n' >notice-pe-initial.md
"$ROOT/tools/collab/registry.py" speak-render "$NOTICE_TARGET" pe \
...
"$ROOT/tools/collab/registry.py" speak-render "$NOTICE_TARGET" pa \
...
"$ROOT/tools/collab/registry.py" rewrite-speak-render "$NOTICE_TARGET" pe \

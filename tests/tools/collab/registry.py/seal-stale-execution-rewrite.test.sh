...
"$ROOT/tools/collab/registry.py" execution "$TARGET" pe completed "2026-05-15T22:00:00+02:00" \
  --assigned-role pe \
  --validation-result passed \
  --validation-scope scoped \
  --touched-path tests/tools/collab/registry.py/seal-stale-execution-rewrite.test.sh \

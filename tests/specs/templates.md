...
Deterministic QA for scaffold template sources projected to `~/.cursor/templates/`.

## Procedure

1. Load every `*.md` under the tracked source directory `templates/`.
...
Tracked scaffold template files under `templates/`:

...
if ! grep -Fq '| `(demo <run>)` | [demo](demo/index.md) | [run](demo/run/index.md) |' "$fixture/commands/commands.md"; then
...
if grep -Fq '| `(commands)` |' "$fixture/commands/commands.md"; then
  printf 'FAIL: root commands/index.md produced a dispatch roster row\n' >&2
  cat "$fixture/commands/commands.md" >&2
  exit 1
fi
if ! grep -Fq '| `(demo run [--force])` | [demo/run/index.md](demo/run/index.md) |' "$fixture/commands/commands.md"; then

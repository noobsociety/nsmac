...
11. If `--cap-exit` is absent and `verificationRounds` is at or above `verificationCap`, **ABORT**: round cap reached; reissue with `--cap-exit reopen-action-plan`, `--cap-exit reopen-handoff`, `--cap-exit follow-up-collab`, or `--cap-exit archive`.

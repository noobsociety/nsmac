...
- **Confirm-before-write:** The confirmation step is mandatory and not optional. Gate contract: `_core/command-argument.md`. On refusal or absent confirmation, no file is written and the marker is untouched.

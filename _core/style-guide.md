...
|Test harnesses |`tests/<source-path>/<source-name>__<behavior>.test.sh`|`tests/_roles/roles__json_schema.test.sh`                                      |
...
Install layout and runtime symlink behavior are out of scope for this `_core/` canon.

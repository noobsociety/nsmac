...
2. **Helper-owned writes.** Every Step that mutates state either names the helper subcommand that performs the write or carries a Notes-level exemption citing `core/framework/route-invariant.md` floor rule 3.

...
| `none` | No default; omitting this parameter triggers the abort-with-contextual-help policy in [`core/framework/command-default.md`](command-default.md) |
...
| Schema and role-JSON validation | Role schema in `core/framework/agent-role.md` |

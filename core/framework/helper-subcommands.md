...
Classification of `tools/collab/registry.py` subcommands by operational role. Operators troubleshooting a failed seal or reopen can use this table to identify which subcommands are safe to invoke directly.

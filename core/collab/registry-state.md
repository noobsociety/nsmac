...
**Module-to-subcommand map row:** `participant-role-files` in `core/collab/helper-output.md` covers the registry-loading commands that invoke this module's validation path.

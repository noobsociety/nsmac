...
This document specifies when to run lifecycle commands during a collab session. It supplements [`agent-effort.md`](../../core/collab/agent-effort.md) (effort levels) and [`agent-model.md`](agent-model.md) (join-time model and harness).

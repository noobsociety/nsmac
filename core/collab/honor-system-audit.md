...
**Maintainer check:** `git grep -rn 'agent-honor-system' commands/` re-generates the full clause inventory. Every result must appear in the table below or be added. Absence is a defect.

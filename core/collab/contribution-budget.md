...
The limit is derived from the `core/framework/context-management.md` 250-line file discipline — the same human load-window rationale applies to contribution length.

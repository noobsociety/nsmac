...
- core/collab/invariants.md: add Invariant #16
...
- [style-guide](../../core/framework/style-guide.md) — imperative instruction shape and LLM-consumed document constraints.
- [document-standard](../../core/framework/document-standard.md) — rule template and document structure.

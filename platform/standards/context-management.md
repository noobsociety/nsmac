...
## platform/standards/ file naming

Every file under `platform/standards/` uses a `<topic>-<type>` two-word pattern. Both words are singular base-form nouns. Gerunds, past participles, and acronyms are not permitted in either position.
